...
### Задание 4
<p align="center">
  <img src="screenshots/S4.png" alt="модуль vpc для создания подсетей в трех доступности, результат из консоли YC" width="800"/>
  <br>
  <em>модуль vpc для создания подсетей в трех доступности, результат из консоли YC</em>
</p> 
